...
public class StringCommonCharsAndCount {
	...
	public static void main(String[] args) {
		...
		System.out.println("String 1 => "
				+ name1.chars().mapToObj(obj -> String.valueOf((char) obj)).sorted().collect(Collectors.toList()));
		System.out.println("String 2 => "
				+ name2.chars().mapToObj(obj -> String.valueOf((char) obj)).sorted().collect(Collectors.toList()));

		List<String> name1List = name1.chars().mapToObj(obj -> String.valueOf((char) obj)).sorted()
				.collect(Collectors.toList());
		List<String> name2List = name2.chars().mapToObj(obj -> String.valueOf((char) obj)).sorted()
				.collect(Collectors.toList());
