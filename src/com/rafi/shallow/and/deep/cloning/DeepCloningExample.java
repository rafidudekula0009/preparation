...
public class DeepCloningExample {
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		DeepStudent student = new DeepStudent(1001, "rafi", new DeepAddress("21", "twopipeline", 518401));
		...
		System.out.println("original object is => " + student); //Student [id=1001, name=rafi, address=Address [houseNo=21, streetName=twopipeline, pincode=518401]]
	}
}
